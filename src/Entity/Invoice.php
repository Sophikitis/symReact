...
class Invoice
{
     ...
     * @Assert\Choice(choices={"SENT", "PAID", "CANCELLED"}, message="Le statut doit etre PAID, SENT ou CANCELLED")
     */
    private $status;
     ...
     * @ORM\Column(type="integer")
     * @Groups({"invoices_read", "customers_read", "invoices_subresource"})
     * @Assert\NotBlank(message="Le numéro de chrono est obligatoire")
